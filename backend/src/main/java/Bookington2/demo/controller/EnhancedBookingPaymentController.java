...
@RestController
@RequestMapping("/api/v1/enhanced-booking-payment")
...
public class EnhancedBookingPaymentController {
    ...
    public ResponseEntity<PaymentResponseDTO> createPayment(
            @Parameter(description = "Booking ID") @RequestParam Integer bookingId,
    ...
    public ResponseEntity<BookingResponseDTO> handlePaymentCallback(
            @Parameter(description = "Payment ID from gateway") @RequestParam String paymentId,
            ...
            @Parameter(description = "Amount") @RequestParam(required = false) String amount,
