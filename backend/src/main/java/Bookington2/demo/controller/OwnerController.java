...
public class OwnerController {
        ...
        @Operation(summary = "Lấy danh sách thông báo", description = "Danh sách thông báo tóm gọn")
        public ResponseEntity<List<BriefNotificationResponse>> getBriefNotifications() {
                return notificationService.getListNotification(getCurrentOwnerId());
        }

        @GetMapping("/notifications/{id}")
        @Operation(summary = "Xem chi tiết thông báo", description = "Lấy thông tin chi tiết của một thông báo")
