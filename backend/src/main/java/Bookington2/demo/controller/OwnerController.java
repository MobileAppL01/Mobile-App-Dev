...
public class OwnerController {
    ...
    public ResponseEntity<APIResponse<List<BookingResponse>>> getBookings(
        ...
        List<BookingResponse> bookings = bookingService.getBookings(getCurrentOwnerId(), locationId, date, status);
    ...
    public ResponseEntity<APIResponse<BookingResponse>> updateBookingStatus(
        ...
        BookingResponse booking = bookingService.updateBookingStatus(id, request.getStatus(), getCurrentOwnerId());
        return ResponseEntity.ok(APIResponse.<BookingResponse>builder()
                .code(1000)
