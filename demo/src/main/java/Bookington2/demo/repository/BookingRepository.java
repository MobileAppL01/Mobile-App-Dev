...
public interface BookingRepository extends JpaRepository<Booking, Integer> {
    ...
    List<Booking> findAllByPlayerId(@Param("playerId") String playerId);
    ...
    Optional<Booking> findByIdAndPlayer_Id(Integer bookingId, String playerId);

    // ==================== OWNER BOOKING APIs ====================

    @Query("SELECT b FROM Booking b WHERE b.court.location.owner.id = :ownerId")
    List<Booking> findAllByOwnerId(@Param("ownerId") String ownerId);

    @Query("SELECT b FROM Booking b WHERE b.court.location.owner.id = :ownerId AND b.court.location.id = :locationId")
    List<Booking> findAllByOwnerIdAndLocationId(@Param("ownerId") String ownerId, @Param("locationId") Integer locationId);

    @Query("SELECT b FROM Booking b WHERE b.court.location.owner.id = :ownerId AND b.bookingDate = :date")
    List<Booking> findAllByOwnerIdAndDate(@Param("ownerId") String ownerId, @Param("date") LocalDate date);

    @Query("SELECT b FROM Booking b WHERE b.court.location.owner.id = :ownerId AND b.status = :status")
    List<Booking> findAllByOwnerIdAndStatus(@Param("ownerId") String ownerId, @Param("status") BookingStatus status);
    ...
    Optional<Booking> findByIdAndOwnerId(@Param("bookingId") Integer bookingId, @Param("ownerId") String ownerId);
    ...
    Long countByOwnerIdAndMonth(@Param("ownerId") String ownerId, @Param("month") int month, @Param("year") int year);
    ...
    Long sumRevenueByOwnerIdAndMonth(@Param("ownerId") String ownerId, @Param("month") int month, @Param("year") int year);
}
